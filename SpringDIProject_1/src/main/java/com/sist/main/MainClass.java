...
public class MainClass {
	public static void main(String[] args) {
		// 1. 컨테이너에 등록 (스프링) 
		// 메모리 할당 후 멤버변수에 값 첨부 => DI (setterDI)
		ApplicationContext app=new ClassPathXmlApplicationContext("application.xml"); 
//		Sawon sa1=(Sawon)app.getBean("sawon");
		Sawon sa1=app.getBean("sawon",Sawon.class);
		...
		System.out.println("위치:"+sa1.getLoc());
		System.out.println("=================================");
		Sawon sa2=app.getBean("sawon2",Sawon.class);
		...
		System.out.println("위치:"+sa2.getLoc());
	}
}
