...
<a href="#" class="btn btn-sm btn-danger" onclick="javascript:history.back()">목록</a>
</td>
</tr>
</table>
</div>
               ...
               <table class="table">
                  ...
                  <tr style="display:none;" id="u${rvo.no }" class="ups">
                     ...
                     <input type="hidden" name="no" value="${rvo.no }">
                        <textarea rows="5" cols="65" name="msg" style="float:left;">
                           ${rvo.msg }
                        </textarea>
                        
                        <button class="btn-primary" style="width:100px;height:103px;float:left;">댓글수정</button>
                     </form>
                     </td>
                  </tr>
               </table>
      ...
      <tr>
         <td>
            ...
            <input type="hidden" name="fno" value="${vo.fno }">
               ...
               <button class="btn-primary" style="width:100px;height:103px;float:left;">댓글쓰기</button>
            </form>
         </td>
      </tr>
   </table>
